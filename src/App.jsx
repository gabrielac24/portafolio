...
function App() {
  ...
  const [menuOpen, setMenuOpen] = useState(false); // Estado para el menú responsivo en móviles
  ...
  return (
    <>
      ...
      <div className="min-h-screen font-sans selection:bg-rose-500/30 selection:text-rose-200 scroll-smooth">
        ...
        <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#0a0306]/90 backdrop-blur-md border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
          <div className="max-w-6xl mx-auto px-6 flex justify-between items-center relative">
            ...
            <span className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">
              Gabriela<span className="text-rose-600">.</span>
            </span>
            ...
            <div className="hidden md:flex gap-8 text-sm font-semibold text-gray-300">
              ...
              <a href="#portafolio" className="hover:text-rose-400 transition-colors">Portafolio</a>
            </div>
            ...
            {/* Botón menú hamburguesa (sólo visible en móviles) */}
            <button 
            ...
            {menuOpen && (
              <div className="absolute top-full left-0 w-full mt-4 bg-[#14050A]/95 backdrop-blur-md border border-white/5 rounded-2xl p-6 flex flex-col gap-4 text-center md:hidden shadow-2xl">
                <a href="#inicio" onClick={() => setMenuOpen(false)} className="text-gray-300 hover:text-rose-400 font-semibold py-2 border-b border-white/5">Inicio</a>
                <a href="#sobre-mi" onClick={() => setMenuOpen(false)} className="text-gray-300 hover:text-rose-400 font-semibold py-2 border-b border-white/5">Sobre Mí</a>
                <a href="#portafolio" onClick={() => setMenuOpen(false)} className="text-gray-300 hover:text-rose-400 font-semibold py-2 border-b border-white/5">Portafolio</a>
                <a href="./CV Gabriela De Casas Arroyo.pdf" target="_blank" rel="noopener noreferrer" onClick={() => setMenuOpen(false)} className="mt-2 bg-rose-600 text-white font-bold py-3 rounded-lg shadow-[0_0_15px_rgba(225,29,72,0.3)]">
                  Descargar CV
                </a>
              </div>
            )}
        ...
        {/* --- HERO SECTION --- */}
        <section id="inicio" className="relative pt-32 pb-20 px-6 min-h-[90vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="max-w-6xl w-full mx-auto flex flex-col md:grid md:grid-cols-2 gap-12 items-center relative z-10">
            
            {/* TEXTOS (Aparecen primero arriba en móviles y lado izquierdo en escritorio) */}
            <div className="text-center md:text-left order-2 md:order-1 mt-8 md:mt-0">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-4 text-white">
                Gabriela <br className="hidden md:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-700">De Casas</span>
              </h1>
              
              {/* Párrafo con efecto de máquina de escribir */}
              <p className="text-lg md:text-2xl text-gray-400 font-light mb-10 max-w-lg min-h-[80px] md:min-h-[64px] mx-auto md:mx-0">
                {typedText}<span className="animate-pulse text-rose-500">|</span>
              </p>
              
              {/* Botones de Redes Sociales */}
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                <a href="https://www.linkedin.com/in/gabriela-de-casas-arroyo-613011412" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 text-white font-bold py-3 px-5 rounded-lg transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:scale-105 flex items-center gap-2 text-sm md:text-base">
                ...
                <a href="https://github.com/gabrielac24" target="_blank" rel="noopener noreferrer" className="bg-[#1a0a13] border border-white/20 hover:border-white/40 text-white font-bold py-3 px-5 rounded-lg transition-all hover:scale-105 backdrop-blur-sm flex items-center gap-2 text-sm md:text-base">
                ...
                <a href="https://instagram.com/gab.dc24" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] hover:opacity-90 text-white font-bold py-3 px-5 rounded-lg transition-all hover:scale-105 shadow-[0_0_20px_rgba(253,29,29,0.3)] flex items-center gap-2 text-sm md:text-base">
            ...
            {/* FOTO E ICONOS (Ahora es visible en celulares también, orden 1 para que salga arriba) */}
            <div className="relative flex justify-center animate-float order-1 md:order-2 mt-12 md:mt-0">
              <div className="absolute inset-0 bg-gradient-to-tr from-rose-600/30 to-purple-900/30 rounded-full blur-3xl"></div>
              <img 
                src="./perfil.jpeg" 
                alt="Gabriela" 
                className="w-56 h-56 md:w-96 md:h-96 object-cover rounded-[2rem] md:rounded-[3rem] border-2 border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)] rotate-3 z-10"
              />
              <div className="absolute -top-4 -right-2 md:-top-6 md:-right-6 bg-[#1a0a13] p-3 md:p-4 rounded-xl border border-rose-900/50 shadow-[0_0_15px_rgba(225,29,72,0.2)] z-20 flex items-center justify-center min-w-[56px] min-h-[56px] md:min-w-[72px] md:min-h-[72px]">
                <span className="text-xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-br from-rose-400 to-rose-700 font-sans tracking-tighter">
                  {'</>'}
                </span>
              </div>
              <div className="absolute -bottom-6 left-6 md:-bottom-10 md:left-10 bg-[#1a0a13] p-3 md:p-4 rounded-xl border border-rose-900/50 shadow-[0_0_15px_rgba(225,29,72,0.2)] z-20">
        ...
        <section id="sobre-mi" className="py-24 relative border-t border-white/5 bg-white/[0.02]">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#0f0409] border border-white/5 p-6 md:p-8 rounded-2xl text-center hover:border-rose-500/30 transition-colors">
                <h4 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-600 mb-2">6+</h4>
                <p className="text-gray-500 text-xs md:text-sm font-semibold uppercase">Proyectos</p>
              </div>
              <div className="bg-[#0f0409] border border-white/5 p-6 md:p-8 rounded-2xl text-center hover:border-rose-500/30 transition-colors">
                <h4 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-600 mb-2">4</h4>
                <p className="text-gray-500 text-xs md:text-sm font-semibold uppercase">Cursos</p>
              </div>
              <div className="bg-[#0f0409] border border-white/5 p-6 md:p-8 rounded-2xl text-center hover:border-rose-500/30 transition-colors col-span-2">
                <h4 className="text-xl md:text-2xl font-bold text-white mb-2">Residencias</h4>
                <p className="text-gray-500 text-xs md:text-sm">Disponibilidad para cambio de residencia</p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:gap-6 mb-16">
              <button 
                ...
                className={`px-4 md:px-6 py-3 md:py-4 rounded-xl font-bold flex items-center gap-2 md:gap-3 transition-all duration-300 text-sm md:text-base ${activeTab === 'projects' ? 'bg-[#1a0a13] border border-rose-500/50 text-rose-400 shadow-[0_0_20px_rgba(225,29,72,0.2)]' : 'bg-[#0f0409] border border-white/5 text-gray-400 hover:text-white hover:border-white/20'}`}
              >
                Proyectos
              </button>
              <button 
                onClick={() => setActiveTab('certificates')} 
                className={`px-4 md:px-6 py-3 md:py-4 rounded-xl font-bold flex items-center gap-2 md:gap-3 transition-all duration-300 text-sm md:text-base ${activeTab === 'certificates' ? 'bg-[#1a0a13] border border-rose-500/50 text-rose-400 shadow-[0_0_20px_rgba(225,29,72,0.2)]' : 'bg-[#0f0409] border border-white/5 text-gray-400 hover:text-white hover:border-white/20'}`}
              >
                Cursos
              </button>
              <button 
                onClick={() => setActiveTab('techStack')} 
                className={`px-4 md:px-6 py-3 md:py-4 rounded-xl font-bold flex items-center gap-2 md:gap-3 transition-all duration-300 text-sm md:text-base ${activeTab === 'techStack' ? 'bg-[#1a0a13] border border-rose-500/50 text-rose-400 shadow-[0_0_20px_rgba(225,29,72,0.2)]' : 'bg-[#0f0409] border border-white/5 text-gray-400 hover:text-white hover:border-white/20'}`}
              >
                Tech Stack
              </button>
            </div>
              ...
              {activeTab === 'techStack' && (
                <div className="flex flex-wrap justify-center items-center gap-4 md:gap-6 pt-8 animate-fade-tab">
                  {habilidadesData.map((habNombre, index) => (
                    <div key={index} className="flex flex-col items-center gap-3 w-[80px] md:w-[120px] group">
                      <div className="bg-[#17050e] w-full aspect-square rounded-xl md:rounded-2xl shadow-sm border border-white/5 flex items-center justify-center group-hover:bg-[#250817] group-hover:border-rose-500/50 group-hover:-translate-y-2 group-hover:shadow-[0_10px_20px_rgba(225,29,72,0.15)] transition-all duration-300 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <TechIcon name={habNombre} />
                      </div>
                      <span className="font-sans font-semibold text-[9px] md:text-xs text-gray-500 text-center tracking-wider uppercase group-hover:text-rose-300 transition-colors">
                        {habNombre}
                      </span>
                    </div>
                  ))}
